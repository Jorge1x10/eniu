    ...
    <View style={{ gap: 8 }}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 10, paddingRight: 4 }}>
        ...
        <Pressable
          ...
          accessibilityLabel={canCreate ? 'Crear otro negocio' : 'Tu plan actual no permite más negocios'}
        ...
        >
          ...
          <Text style={{ color: canCreate ? theme.text : theme.muted, fontWeight: '800' }}>Nuevo</Text>
        </Pressable>
      </ScrollView>
