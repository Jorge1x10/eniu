...
export function GoogleAuthButton({ mode }: { mode: 'login' | 'register' }) {
  ...
  async function authenticate() {
    if (Constants.appOwnership === 'expo') {
      setError('Google requiere el development build de Eniu; no funciona dentro de Expo Go. Usa npm run android:dev o un build de EAS.');
      return;
    }
