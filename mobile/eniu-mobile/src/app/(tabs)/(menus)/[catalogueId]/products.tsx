...
export default function ProductsScreen() {
  ...
  async function save() {
    ...
    const fields = { name: name.trim(), description: description.trim(), price: price || null, category_id: editing?.category_id ?? null, is_available: available };
    ...
    try {
      ...
      if (usesForm) {
        ...
        pickedPictures.forEach((picture) => form.append('images', { uri: picture.uri, name: picture.name, type: picture.type } as unknown as Blob));
        if (editing) {
