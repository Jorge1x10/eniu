  ...
  return (
    <main className="min-h-dvh bg-[#FFFDF5] px-5 py-12">
      <article className="mx-auto w-full max-w-3xl">
        ...
        <h1 className="mt-6 text-3xl font-black text-[#111111] sm:text-4xl">Términos y condiciones</h1>
        ...
        <Seccion titulo="Privacidad">
          <p>El tratamiento de datos personales se describe en el <Link to="/privacidad" className="font-semibold underline underline-offset-4">aviso de privacidad</Link>,
          que forma parte de estos términos.</p>
        </Seccion>
