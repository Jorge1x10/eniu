...
export default function HomePage() {
  ...
  return <section className="min-w-0 space-y-6 overflow-x-hidden p-2 text-[#111111] font-['Manrope',ui-sans-serif,system-ui] sm:p-4">
    <header className="flex flex-col gap-5 rounded-xl bg-white sm:flex-row sm:items-start sm:justify-between p-3 items-center justify-center h-20"><div><h1 className="text-[25px] font-extrabold leading-tight">Hola, {visibleName} 👋</h1><p className="mt-1 text-xs text-[#2A2A2A]">Así se están comportando tus menús hoy.</p></div><button type="button" onClick={openCreateMenu} className="inline-flex min-h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#FFE05A] px-4.5 text-sm font-bold hover:bg-[#E8C93D] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#111111] sm:w-auto"><Plus aria-hidden="true" size={18} /> Crear menú</button></header>
